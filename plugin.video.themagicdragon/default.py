...
def SKindex():
    addon_log("SKindex")
    addDir('[B][COLOR blue]Donate Here - paypal.me/PyramidRaider[/B][/COLOR]','[B][COLORblue]Donate Here - paypal.me/PyramidRaider[/B][/COLOR]',4,'http://pngimg.com/uploads/paypal/paypal_PNG22.png' ,  FANART,'','','','')	
	...
	if Search_name == '':
		...
		for name2,url2,image2,fanart2 in match2:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')	
		HTML54 = Open_Url('https://raw.githubusercontent.com/tombebbs1/magicdragon/master/christmas2019.txt')
		match2 = re.compile('<title>(.+?)</title>.+?<link>(.+?)</link>.+?<thumbnail>(.+?)</thumbnail>.+?<fanart>(.+?)/fanart>',re.DOTALL).findall(HTML54)
		for name2,url2,image2,fanart2 in match2:
			if fanart2 == '<':
				fanart2 = FANART
			else:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')
		HTML55 = Open_Url('https://raw.githubusercontent.com/tombebbs1/magicdragon/master/nr4.txt')
		match2 = re.compile('<title>(.+?)</title>.+?<link>(.+?)</link>.+?<thumbnail>(.+?)</thumbnail>.+?<fanart>(.+?)/fanart>',re.DOTALL).findall(HTML55)
		for name2,url2,image2,fanart2 in match2:
			if fanart2 == '<':
				fanart2 = FANART
			else:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')
		HTML56 = Open_Url('https://raw.githubusercontent.com/tombebbs1/magicdragon/master/nr5.txt')
		match2 = re.compile('<title>(.+?)</title>.+?<link>(.+?)</link>.+?<thumbnail>(.+?)</thumbnail>.+?<fanart>(.+?)/fanart>',re.DOTALL).findall(HTML56)
		for name2,url2,image2,fanart2 in match2:
			if fanart2 == '<':
				fanart2 = FANART
			else:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')
		HTML57 = Open_Url('https://raw.githubusercontent.com/tombebbs1/magicdragon/master/requestedmovies.txt')
		match2 = re.compile('<title>(.+?)</title>.+?<link>(.+?)</link>.+?<thumbnail>(.+?)</thumbnail>.+?<fanart>(.+?)/fanart>',re.DOTALL).findall(HTML57)
		for name2,url2,image2,fanart2 in match2:
			if fanart2 == '<':
				fanart2 = FANART
			else:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')
		HTML58 = Open_Url('https://raw.githubusercontent.com/tombebbs1/magicdragon/master/uhda-l.txt')
		match2 = re.compile('<title>(.+?)</title>.+?<link>(.+?)</link>.+?<thumbnail>(.+?)</thumbnail>.+?<fanart>(.+?)/fanart>',re.DOTALL).findall(HTML58)
		for name2,url2,image2,fanart2 in match2:
			if fanart2 == '<':
				fanart2 = FANART
			else:
			...
			if 'sublink' in url2:
				...
				if Search_title in name2.lower().replace(' ',''):
					addDir(name2,url2,1,image2,fanart2,'','','','')	
		HTML59 = Open_Url('https://raw.githubusercontent.com/tombebbs1/magicdragon/master/uhdm-z.txt')
		match2 = re.compile('<title>(.+?)</title>.+?<link>(.+?)</link>.+?<thumbnail>(.+?)</thumbnail>.+?<fanart>(.+?)/fanart>',re.DOTALL).findall(HTML59)
		for name2,url2,image2,fanart2 in match2:
			if fanart2 == '<':
				fanart2 = FANART
			else:
...
def catchuptv():
	url = 'http://www1.projectfreetv.ag/schedule-tv/'
