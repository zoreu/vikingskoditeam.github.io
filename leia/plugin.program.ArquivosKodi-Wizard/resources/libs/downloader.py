...
def _pbhook(numblocks, blocksize, filesize, dp, start_time):
	try: 
		...
		mbs = '[COLOR %s][B]Tamanho:[/B] [COLOR %s]%.02f[/COLOR] MB of [COLOR %s]%.02f[/COLOR] MB[/COLOR]' % (COLOR2, COLOR1, currently_downloaded, COLOR1, total) 
		...
		wiz.log("ERROR Baixando: %s" % str(e), xbmc.LOGERROR)
		pass
	if dp.iscanceled(): 
		dp.close()
