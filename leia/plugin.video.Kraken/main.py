...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR blueviolet]BEM-VINDOS AO [COLOR gold][B]KRAKEN[/COLOR][/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "KRAKEN - Melhor conteudo de filmes e séries para você e toda sua família"
####  LINK DO TITULO DE MENU  #########################################################
url_title = 'AGRADECEMOS POR USAREM O ADDON - ASS: DAVY JONES'

#### MENSAGEM BEM VINDOS  #############################################################
titulo_boas_vindas = "BEM-VINDOS"
mensagem_bem_vindo = "[B][COLOR white]Obrigado por terem escolhido o KRAKEN[/COLOR]\n[COLOR white]Entre no nosso grupo do:[/COLOR] [COLOR green]Whatsaap[/COLOR] (11) 95202-7986[/B]"
####  MENSAGEM SECUNDARIA ######################################################
mensagem_secundaria = "[COLOR gold][B]KRAKEN[/B][/COLOR] - [COLOR white][B]TESOUROS NÃO SÃO APENAS, OURO E PRATA[/B][/COLOR]"
...
thumb_icon_config = ''
desc_configuracoes = "Configurações do KRAKEN"
...
#### MENU VIP ################################################################
titulo_vip = "[B][COLOR blueviolet]KRAKEN[/COLOR]  [COLOR gold](IPTV - P2P)[/COLOR][/B]"
...
#Base
url_b64_principal = 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL0FudWJpcy10ZWFtL0FuLWJpcy9tYXN0ZXIvQ2F0ZWdvcmlhcw=='
...
def SKindex():
    ...
    if addon.getSetting('mensagem2') == 'true':
        ...
        xbmc.executebuiltin('Notification(%s, %s, %d, %s)'%(__addonname__,getRequest2('https://pastebin.com/raw/J10qxq4s', 'https://pastebin.com/raw/J10qxq4s'), time_msg, __icon__))
