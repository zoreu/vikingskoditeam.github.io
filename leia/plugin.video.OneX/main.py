...
def streamtape(url):
    ...
    if link_part1_re !=[] and link_part2_re !=[]:
        ...
        link = 'https:'+link_part1_re[0]+'&token='+link_part2_re[0]+'&stream=1|User-Agent=Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.130 Safari/537.36'
    else:
        link = ''
    return link
