...
def get_links(tv_movie,original_title,season_n,episode_n,season,episode,show_original_year,id):
    ...
    for itt in search_url:
     for page in range(1,4):
        ...
        x=scraper.get('https://btdb.io/search/%s/?sort=popular&page=%s'%(itt,str(page))).content
        logging.warning('https://btdb.io/search/%s/?sort=popular&page=%s'%(itt,str(page)))
