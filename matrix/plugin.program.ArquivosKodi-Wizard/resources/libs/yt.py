...
def DecryptSignatureNew(s, playerUrl):
    ...
    if match:
        ...
        print('Falha ao obter o nome da função de assinatura principal')
        return ''
    ...
    try:
        ...
        print('Falha ao obter o código decryptSignature: {0}'.format(str(e)))
        return ''
    ...
    try:
        ...
        print('descriptografar o código de assinatura falhou ao executar corretamente: {0}'.format(str(e)))
        return ''
