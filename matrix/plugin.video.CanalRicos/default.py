...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = '[B][COLOR white]BEM-VINDOS AO[/COLOR][/B] [COLOR blueviolet][B]CANAL RICOS[/COLOR][/B]'
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = 'WEB TV CANAL RICOS - Acompanhe a nossa programação 24hrs.'
...
thumb_icon_config = ''
desc_configuracoes = 'Configurações do Canal Ricos'
## FAVORITOS
...
#### DESCRIÇÃO VIP ###########################################################
vip_descricao = 'SOLICITE SEU ACESSO VIP'
...
url_b64_principal = 'aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2Rqcmljb3MvQ2FuYWxSaWNvcy9tYXN0ZXIvTUVOVSUyMEJBU0UlMjBQUklOQ0lQQUw='
