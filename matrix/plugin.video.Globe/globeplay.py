...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR white]||||||| Globe Play |||||||[/COLOR][/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "Cursos, filmes e série totalmente GRATUITOS \n\nNome inspirado no meme Globe\n\nFocado em torrent, logo é obrigatório o uso do Elementum ou Quasar\n\n[B]NÃO HOSPEDAMOS NADA[/B] \n\n[B][COLOR white]Versão: [/COLOR][COLOR magenta]1.0.1[/COLOR][/B]\n\n[B][COLOR yellow]Doações:[/COLOR][/B] [COLOR violet]Sua doação é semear os torrents.[/COLOR] \n\nAddon de código aberto!!!"
...
dialog_playlist = '[B][COLOR white]Selecione um item:[/COLOR][/B]'
...
url_origem = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3L0FzRWZCcUxn'
try:
    ...
    for item in items:
        ...
        try:
            ...
            #Multilink
                ...
                name_resolve = name+'[COLOR blue] ('+str(len(url2))+' links)[/COLOR]'
...
def vip():
    ...
    vip_menu = addon.getSetting('False')
