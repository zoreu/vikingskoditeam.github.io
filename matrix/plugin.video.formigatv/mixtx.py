...
url_principal = 'https://s3.us-west-1.wasabisys.com/addonformiga/Menu/MenuADDONFORMIGAtv.txt'
#url_principal = ""
...
def getData(url,fanart,pesquisa=False):
    ...
    if isinstance(data, (int, str, list)):
        ...
        channels = re.compile('<canais>(.+?)</canais>',re.MULTILINE|re.DOTALL).findall(data)

        channel = re.compile('<canal>(.*?)</canal>',re.MULTILINE|re.DOTALL).findall(data)
            ...
            for channel in channel:
                ...
                try:
                    ...
                    if linkedUrl=='':
                        ...
                        if adult == 'false' and re.search("n",name,re.IGNORECASE) and name.find('(+18)') >=0:
...
def SKindex():
    ...
    #addDir("Add Youtube Conteudo",20)
    #addDir("",'',21,__icon__,'',title_descricao,'','','','','','','','','','','','','','','','')
    #addDir("[B]Adicionar Youtube                             [/B][COLOR cyan][B]||| Hidra [/B][/COLOR][COLOR pink][B]Tuxedo |||[/B][/COLOR]",'',20,__icon__,'',title_descricao,'','','','','','','','','','','','','','','','')
    #addDir("[B]Visualizar os Conteudos adicionados do Youtube[/B][COLOR cyan][B]||| Hidra [/B][/COLOR][COLOR pink][B]Tuxedo |||[/B][/COLOR]",'',21,__icon__,'',title_descricao,'','','','','','','','','','','','','','','','')
    #addDir("[B]League Of Legends Campeonatos [/B][COLOR cyan][B]||| Hidra [/B][/COLOR][COLOR pink][B]Tuxedo |||[/B][/COLOR]",'',22,"https://github.com/kodishmediacenter/Rework-hidra/blob/main/icones/ddcw3vz-fbbdb42b-5378-4929-99c5-18deb56484c7.png",'',title_descricao,'','','','','','','','','','','','','','','','')
    ...
    #addDir("[B]Kodish Cloud Space [/B][COLOR cyan][B]||| Hidra [/B][/COLOR][COLOR pink][B]Tuxedo |||[/B][/COLOR]",'',25,__icon__,'',title_descricao,'','','','','','','','','','','','','','','','')    
    #addDir("[B]BBB 2022 | Laucher [/B][COLOR cyan][B]||| Hidra [/B][/COLOR][COLOR pink][B]Tuxedo |||[/B][/COLOR]",'',23,"https://imagens.ne10.uol.com.br/veiculos/_midias/jpg/2022/01/06/bbb_1024x769-20408077.jpg",'',title_descricao,'','','','','','','','','','','','','','','','')
    #addDir("",'',21,__icon__,'',title_descricao,'','','','','','','','','','','','','','','','')
