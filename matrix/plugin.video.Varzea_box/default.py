...
nome_contador = "VARZEA BOX"
link_contador = "https://whos.amung.us/pingjs/"    


##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = "[B][COLOR white]||||||| Varzea Box|||||||[/COLOR][/B]"
###  DESCRIÇÃO DO ADDON ###############################################################
title_descricao = "O PRIMEIRO agregador de canais de WebTv para Kodi e Smartvs do mundo,trazendo até o conforto de sua casa os melhores programas e jogos ao vivo de canais de esporte amador com muita resenha e diversão."
...
fanart_pesquisar = ''
#### Descrição Pesquisa
desc_pesquisa = 'Pesquise por Jogo'
## MENU CONFIGURAÇÕES
...
#### MENU VIP ################################################################
titulo_vip = "[B][COLOR white]VARZEA BOX[/COLOR] - [COLOR gold](VIP)[/COLOR][/B]"
...
url_origem = 'https://pastebin.com/raw/mU1RMLeV'
try:
...
def init_SKindex(msg):
   ...
   if status_mensagem1 == 'true':
    dialog = xbmcgui.Dialog()
    link = dialog.select("[B]BEM-VINDOS AO [COLOR white]VARZEA BOX[/COLOR][/B]", [
    "[B][COLOR white]Visitar nosso - [/COLOR] Facebook 1 [/B]",
    "[B][COLOR white]Visitar nosso - [/COLOR] Instagram 2 [/B]",
    "[B][COLOR white]Solicitar inclusão de  - [/COLOR] WebTV 3 [/B]",
    "[B][COLOR white]Varzea Box - [/COLOR] ENTRAR NA TV [/B]"])    
      
    if link == 0:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://www.facebook.com/cabhelp.santos' ) )
     else:
        ost = webbrowser . open ( 'https://www.facebook.com/cabhelp.santos' )
 
    if link == 1:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://www.instagram.com/cabhelp/' ) )
     else:
        ost = webbrowser . open ( 'https://www.instagram.com/cabhelp/' )
    
    if link == 2:
     if xbmc . getCondVisibility ( 'system.platform.android' ) :
         ost = xbmc . executebuiltin ( 'StartAndroidActivity(,android.intent.action.VIEW,,%s)' % ( 'https://forms.gle/N6riY1YSyiUFNAoz9' ) )
     else:
        webbrowser . open ( 'https://forms.gle/N6riY1YSyiUFNAoz9' ) 
